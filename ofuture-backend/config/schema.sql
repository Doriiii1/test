...
-- ============================================================
-- ALTER TABLES: Add missing columns for admin functionality
-- ============================================================

-- Add status column to users table for admin management
ALTER TABLE users ADD COLUMN IF NOT EXISTS status ENUM('active', 'locked') NOT NULL DEFAULT 'active' AFTER is_active;
